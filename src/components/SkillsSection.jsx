...
const skills = [
  ...
  { name: "Microsoft SQL", level: 85, category: "backend" },
  { name: "Redis", level: 75, category: "backend" },
  { name: "Table Storage", level: 75, category: "backend" },
  ...
  {name: "API Apps", level: 80, category: "cloud"},
  {name: "Web Jobs", level: 80, category: "cloud"},
];
